  ...
  return (
    <>
      <div className='bg-blue-200 w-full h-screen flex justify-center'>
          ...
          <div className='w-full hfull sm:h-5/6 flex flex-col md:1/2 lg:w-1/3 bg-gradient-to-r from-blue-800 to-purple-700 p-8 md:m-10 md:rounded-lg text-white shadow-slate-400 shadow-xl '>
